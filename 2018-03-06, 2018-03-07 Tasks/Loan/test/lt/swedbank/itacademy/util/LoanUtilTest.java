...
public class LoanUtilTest {
    ...
    public void testIsValid() {
        assertTrue(LoanUtil.isValid(loans[1]));
    }

    @Test
    public void testCalculateInterests() {
        assertEquals(new BigDecimal(150), LoanUtil.calculateInterests(loans[0]));
    }

    @Test
    public void testTotalLoanCost() {
        assertEquals(new BigDecimal(1150), LoanUtil.calculateTotalLoanCost(loans[0]));
    }

    @Test(expected = NullPointerException.class)
    public void testTotalLoanCostWhenNull() {
        LoanUtil.calculateTotalLoanCost(null);
    }
}