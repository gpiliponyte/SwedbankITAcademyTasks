...
public class Task3DomainInitializer implements DomainInitializer {
    ...
    public Loan[] initializeLoans() {
        ...
        ((LandLoan)loans[0]).setDistrict("Vilnius, FabijoniÅ¡kiÅ³ raj.");
        ...
        ((LandLoan)loans[1]).setDistrict("KlaipÄ—da, MelnragÄ—");
        ...
        ((HouseLoan)loans[3]).setDistrict("KazlÅ³ RÅ«da");
        ...
        ((HouseLoan)loans[4]).setDistrict("Vilnius, NaujininkÅ³ raj.");
