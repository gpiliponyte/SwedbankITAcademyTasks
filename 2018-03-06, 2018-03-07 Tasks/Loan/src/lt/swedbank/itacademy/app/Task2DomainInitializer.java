...
public class Task2DomainInitializer implements DomainInitializer {
    ...
    public Loan[] initializeLoans() {
        ...
        ((RealEstateLoan)loans[0]).setDistrict("Vilnius, FabijoniÅkiÅ³ raj.");
        ...
        ((RealEstateLoan)loans[1]).setDistrict("KlaipÄ—da, MelnragÄ—");
        ...
        ((RealEstateLoan)loans[3]).setDistrict("KazlÅ³ RÅ«da");
        ...
        ((RealEstateLoan)loans[4]).setDistrict("Vilnius, NaujininkÅ³ raj.");
